class EyeColorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @eye_color.save
        format.html { redirect_to @eye_color, notice: 'El Color de Ojos ha sido creado exitosamente.' }
  ...
  def update
    respond_to do |format|
      if @eye_color.update(eye_color_params)
        format.html { redirect_to @eye_color, notice: 'El Color de Ojos ha sido actualizado exitosamente.' }
  ...
  def destroy
    @eye_color.destroy
    respond_to do |format|
      format.html { redirect_to eye_colors_url, notice: 'El Color de Ojos ha sido eliminado exitosamente.' }
  ...
  private
    ...
    def eye_color_params
      params.require(:eye_color).permit(:name)
    end
end
