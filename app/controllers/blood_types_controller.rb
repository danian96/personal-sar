class BloodTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @blood_type.save
        format.html { redirect_to @blood_type, notice: 'El Grupo Sanguineo ha sido creado exitosamente.' }
  ...
  def update
    respond_to do |format|
      if @blood_type.update(blood_type_params)
        format.html { redirect_to @blood_type, notice: 'El Grupo Sanguineo ha sido actualizado exitosamente.' }
  ...
  def destroy
    @blood_type.destroy
    respond_to do |format|
      format.html { redirect_to blood_types_url, notice: 'El Grupo Sanguineo ha sido eliminado exitosamente.' }
