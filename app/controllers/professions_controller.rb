class ProfessionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @profession.save
        format.html { redirect_to @profession, notice: 'La Profesion ha sido creada exitosamente.' }
  ...
  def update
    respond_to do |format|
      if @profession.update(profession_params)
        format.html { redirect_to @profession, notice: 'La Profesion ha sido actualizada exitosamente.' }
  ...
  def destroy
    @profession.destroy
    respond_to do |format|
      format.html { redirect_to professions_url, notice: 'La Profesion ha sido eliminada exitosamente.' }
