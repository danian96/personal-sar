! function(e, t) {
    ...
    var t = "SweetAlert2:",
        ...
        Y = function(e) {
            ...
            if (t && (t.parentNode.removeChild(t), U([document.documentElement, document.body], [I["no-backdrop"], I["toast-shown"], I["has-column"]])), !O()) {
                ...
                var m = function(e) {
                    Se.isVisible() && i !== e.target.value && Se.resetValidationMessage(), i = e.target.value
                };
        ...
        ee = function(e) {
            ...
            if (e.type)
                if (-1 !== Object.keys(f).indexOf(e.type)) {
                    var o = Se.getPopup().querySelector(".".concat(I.icon, ".").concat(f[e.type]));
        ...
        ne = function(i) {
            var r = x(),
                a = parseInt(null === i.currentProgressStep ? Se.getQueueStep() : i.currentProgressStep, 10);
    ...
    var xe, Ae = Object.freeze({
        ...
        update: function(t) {
            var n = {};
            Object.keys(t).forEach(function(e) {
                Se.isUpdatableParameter(e) ? n[e] = t[e] : q('Invalid parameter to update: "'.concat(e, '". Updatable params are listed here: TODO (@limonte) add link'))
            });
